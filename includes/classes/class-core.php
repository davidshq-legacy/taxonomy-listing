<?php
    ...
    class SCRPTZ_TDL_Core
    {
        public static function get_term_children() {
            global $wp_query;
            $term_children = get_term_children( $wp_query->queried_object->term_id, $wp_query->queried_object->taxonomy );
        ...
        public static function get_term_children_list($term_children) {
            ...
            foreach ($term_children as $index => $term_child) {
                $data['term'] = get_term($term_child, $wp_query->queried_object->taxonomy);
